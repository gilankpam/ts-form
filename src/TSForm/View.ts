module TSForm {
    ...
    export class View {
        ...
        // The default `_tagName` of a View's element is `div`
        ...
        public tagName(tagName: string): this {
        ...
        protected _ensureElement() {
            if (!this.el) {
                ...
                if (this._id) attrs.id = _.result(this, '_id');
                if (this._className) attrs['class'] = _.result(this, '_className');
